...
async function displayAlbums() {
    ...
    Array.from(anchors).forEach(async e => {
        if (e.href.includes("/songs")) {
            ...
            <div class="play">
                <div
                    style="width: 45px; height: 45px; background-color: #1fdf64; border-radius: 50%; display: flex; justify-content: center; align-items: center;">
     ...
     //    load the play list whenever crad is click
...
async function main() {
    ...
    songs = await getSongs("songs/pop")
    ...
    // add an event listener to preivous 
